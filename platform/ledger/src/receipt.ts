import type { Order, PaymentIntent, Refund } from './domain/types.js';
...
export function buildReceipt(order: Order, payments: readonly PaymentIntent[], refunds: readonly Refund[], issuedAt: string): Receipt {
